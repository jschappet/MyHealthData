...
class WeightControllerOff: UIViewController,  UITableViewDataSource, UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.refreshControl.addTarget(self, action: #selector(WeightControllerOff.refresh(_:)) ,   for: UIControlEvents.valueChanged)
